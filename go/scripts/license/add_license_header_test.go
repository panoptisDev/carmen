...
func Test_Recognizes_GethLicense(t *testing.T) {
	...
	require.NoError(t, processFiles(originalFileName, ".go", "//", gethHeader, false, nil))
...
func Test_Recognizes_CurrentSonicLicense(t *testing.T) {
	...
	require.NoError(t, processFiles(tmpFileName, ".go", "//", licenseHeader, false, nil))
...
func Test_IgnoresMockFile(t *testing.T) {
	...
	require.NoError(t, processFiles(tmpFileName, ".go", "//", licenseHeader, false, []string{"_mock.go"}))
